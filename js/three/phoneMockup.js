...
loader.load('/assets/models/phone.glb', handle_load);
...
function resizeRendererToDisplaySize(renderer) {
    ...
    if (needResize) {
      ...
      camera.position.z = 
        ...
        20 - (xxxxlBreakPoint / smBreakPoint)*2.3 : 
        (window.innerWidth > mdBreakPoint) ? 
        20 - (window.innerWidth / smBreakPoint)*2.3 : 
        10;
...
function animate() {
    ...
    camera.position.x += ((window.innerWidth > mdBreakPoint) ? .05 : 0) + ( mouseX - camera.position.x ) * .05;
