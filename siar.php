...
<div id="projContent"> <!--___________ Proj Content ____________-->
  ...
  <section class="sectionText">
    ...
    <p>My roles in the development of Rising Waters included concept design, <a href="#RisingWatersDev">C# and Unity decelopment</a>, as well as 3D modelling the majority of 3D assets. In Blender, I modelled buildings, as well as local features such as the SkyTrain and Richmond banners, and completed them with textures sourced from online.</p>
  </section>
