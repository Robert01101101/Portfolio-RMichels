...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 19, 2021 at 11:01 PM
...
(5, 'Portfolio (v2)', 'Website (Full-Stack)', '2020', 'portfolio', b'1'),
...
--
-- Indexes for table `omen`
--
ALTER TABLE `omen`
  ADD PRIMARY KEY (`omen_id`),
  ADD KEY `fk_omen_aspect_id` (`aspect_id`),
  ADD KEY `fk_omen_death_id` (`death_id`),
  ADD KEY `fk_omen_fault_id` (`fault_id`);
...
ALTER TABLE `project_roles`
  ADD KEY `fk_project_roles_project_id` (`project_id`),
  ADD KEY `fk_project_roles_role_id` (`role_id`);

--
-- Indexes for table `project_teammembers`
--
ALTER TABLE `project_teammembers`
  ADD KEY `fk_project_teammembers_project_id` (`project_id`),
  ADD KEY `fk_project_teammembers_teammember_id` (`teammember_id`);
...
--
-- Indexes for table `user_omen`
--
ALTER TABLE `user_omen`
  ADD KEY `fk_user_omen_user_id` (`user_id`),
  ADD KEY `fk_user_omen_omen_id` (`omen_id`);
...
--
-- AUTO_INCREMENT for table `omen`
--
ALTER TABLE `omen`
  MODIFY `omen_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
