...
<div id="projContent"> <!--___________ Proj Content ____________-->
  ...
  <section class="sectionText">
    ...
    <p>Developed with C# in Unity, as a pop-up accessible through the observation details view in the Clirio View app. UI designed in Figma in collaboration with <a href="https://www.linkedin.com/in/jordan-wischmann-32a4b380/" target="_blank">Jordan Wischmann</a>.</p>

    <h3>Webviewer</h3>
    <p>Developed with Blazor APS.NET and Three.js. Backend token sharing implemented by <a href="https://www.linkedin.com/in/timthibault/" target="_blank">Timothy Thibault</a>.</p>
  </section>
